      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        <div class="row justify-content-center">
          <div class="col-lg-8 text-center">
            <h2>welcome di web pembalap</h2>
            <p>p balap <span class="typed" data-typed-items="300meter, 1000meter, 200meter, 100meter"></span><span class="typed-cursor" aria-hidden="true"></span></p>
            ...
            <div class="profile-card">
              <div class="profile-header">
                <div class="profile-avatar">
                  <img src="{{ asset('assets/img/profile/bg.jpg') }}" alt="Profile Image">
